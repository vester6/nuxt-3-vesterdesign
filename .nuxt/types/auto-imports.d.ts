...
declare global {
  ...
  const useStoryblok: typeof import('@storyblok/vue')['useStoryblok']
  const useStoryblokApi: typeof import('@storyblok/vue')['useStoryblokApi']
  const useStoryblokBridge: typeof import('@storyblok/vue')['useStoryblokBridge']
